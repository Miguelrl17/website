...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-900 via-blue-950 to-slate-900 text-slate-400 selection:bg-teal-300 selection:text-teal-900">
                ...
                <ol className="group/list">
                  <li className="mb-12">
                    <ExperienceItem
                      ...
                      company="FoundersSuite"
                      description="Architected a Two-Tower neural retrieval system using TensorFlow/Keras, generating L2-normalized 64-dimensional embeddings to optimize vector-matching latency and achieve a 0.90 ROC-AUC score. Engineered a high-throughput FastAPI microservice backed by 20+ PostgreSQL tables, implementing Supabase JWT (ES256) authentication and strict Row-Level Security (RLS) to isolate multi-tenant data at the storage layer. Selected as Business Competition Finalist; defended platform infrastructure scalability to a panel of venture capitalists."
                      technologies={[
                        "TensorFlow",
                        "Keras",
                        "FastAPI",
            ...
            >
              ...
              <div>
                <ol className="group/list">
                  ...
                  <li className="mb-12">
                    <ProjectCard
                      title="CHEFCITO | Intelligent Grocery & Recipe Hub"
                      description="Built an edge-assisted grocery logging and personalized recipe discovery platform. Engineered a FastAPI backend integrating Google MediaPipe object detection alongside an in-house custom CV model to detect 30+ grocery types and scan barcodes. Developed a highly customized vector ranking engine using NumPy to execute TF-IDF feature extraction, cosine similarity matching, and a ten-dimensional multi-weight linear ranker for real-time, on-device user recommendations."
                      technologies={[
                        "FastAPI",
                        "NumPy",
                        "MediaPipe",
